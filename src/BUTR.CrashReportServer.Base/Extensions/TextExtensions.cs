...
public static class TextExtensions
{
    ...
    public static Stream AsStream(this string @string, Encoding? encoding = null) => (@string ?? throw new ArgumentNullException(nameof(@string))).AsMemory().AsStream(encoding);
